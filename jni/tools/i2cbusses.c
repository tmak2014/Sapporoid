...
//	__android_log_write("SVT1", "SVT2", "open_i2c_dev #1");

//	sprintf(filename, "/dev/i2c/%d", i2cbus);
//	file = open(filename, O_RDWR);

//	__android_log_write("SVT1", "SVT2", "open_i2c_dev #2");
//	if (file < 0 && errno == ENOENT) {
//		__android_log_write("SVT1", "SVT2", "open_i2c_dev #3");
		sprintf(filename, "/dev/i2c-%d", i2cbus);
		file = open(filename, O_RDWR);
//		__android_log_write("SVT1", "SVT2", "open_i2c_dev #4");
//	}

	if (file < 0 && !quiet) {
//		__android_log_write("SVT1", "SVT2", "open_i2c_dev #5");
		if (errno == ENOENT) {
//			__android_log_write("SVT1", "SVT2", "open_i2c_dev #6");
			fprintf(stderr, "Error: Could not open file "
				"`/dev/i2c-%d' or `/dev/i2c/%d': %s\n",
				i2cbus, i2cbus, strerror(ENOENT));
		} else {
//			__android_log_write("SVT1", "SVT2", "open_i2c_dev #7");
			fprintf(stderr, "Error: Could not open file "
